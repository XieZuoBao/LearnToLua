...
public class Packager
{
    ...
    static void HandleExampleBundle()
    {
        ...
        //第一个参数是包名;AppConst.ExtName是拓展名
        //第二个参数是打包文件格式
        //第三个参数是打包资源的源目录
        //打包FirstPanel
        AddBuildMap("first" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Custom/FirstPanel");
        //打包ImgOrc
        AddBuildMap("prefabs" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Custom/Prefab");
        //打包LoginPanel
        AddBuildMap("login" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Custom/LoginPanel");
